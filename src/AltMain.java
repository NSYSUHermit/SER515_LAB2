...
public class AltMain {
    public static void main(String[] args) {
        ...
        System.out.println("System property data = " + System.getProperty("data"));
        System.out.println("System property vi = " + System.getProperty("vi"));
        if (filePath == null) {
        ...
        int totalCost = new AltVehicleService(viProp).calculateTotal(vehicles.toArray(new IVehicle[0]));
